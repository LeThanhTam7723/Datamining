            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    ...
                    <div class="product__details__pic__item" style="text-align: center">
                        <img class="product__details__pic__item--large" style ="min-width:50%;"
...
<!--Danh sách các sản phẩm được mua kèm-->
<section class="related-product">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title related__product__title">
                    <h2>Sản phẩm được mua kèm nhiều nhất</h2>
                </div>
            </div>
        </div>
        <div class="row">
            <%
                List<Products> relatedProducts1 = (List<Products>) request.getAttribute("proBuyWith");
                if (relatedProducts != null) {
                    for (Products product : relatedProducts1) {
            %>
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="<%= product.getImage() %>">
